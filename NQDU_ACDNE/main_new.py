...
from dvrl_acdne import DVRL_ACDNE
from ACDNE import ACDNE_Trainer


def main(args, num):
    print('num:',num)
    print('*source:' + args.source + ' target:' + args.target)
    # Data loading
    ...
    pred_model = ACDNE_Trainer(args, dataset)
    ...
    dvrl = DVRL_ACDNE(args, pred_model, flags)
